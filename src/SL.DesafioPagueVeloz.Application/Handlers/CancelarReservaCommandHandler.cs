    ...
    public class CancelarReservaCommandHandler : IRequestHandler<CancelarReservaCommand, OperationResult<TransacaoDTO>>
    {
            ...
            CancellationToken cancellationToken)
        {
            try
            {
                ...
                // Executar operação de cancelamento de reserva
                ...
                return OperationResult<TransacaoDTO>.SuccessResult(resultado, "Cancelamento de reserva realizado com sucesso");
            }
            ...
            catch (Exception ex)
            {
                ...
                return OperationResult<TransacaoDTO>.FailureResult(
                    "Erro ao processar cancelamento de reserva",
                    ex.Message);
            }
        }
    }
