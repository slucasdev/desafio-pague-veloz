...
{
    public class EstornarCommandValidator : AbstractValidator<EstornarCommand>
    {
        public EstornarCommandValidator()
        {
            RuleFor(x => x.ContaId)
            ...
            RuleFor(x => x.TransacaoOriginalId)
                .NotEmpty().WithMessage("TransacaoOriginalId é obrigatório");
